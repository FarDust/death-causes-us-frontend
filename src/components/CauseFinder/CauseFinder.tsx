...
import { createFavouriteHandler } from "../../utils/favouriteHandler";
    ...
    <List component="nav">
      {causesOfDeath.map((causeOfDeath) => (
        <ListItem key={causeOfDeath.id}>
          ...
          <ListItemIcon sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }} onClick={createFavouriteHandler(causeOfDeath, favouriteControl.addFavourite,
